...
1. **Landing Gear Wire**  
   ![landing gear pic](../images/homebrew/landing_gear_module.jpg)

2. **MAUCH Battery Eliminate Circuit (BEC)**  
   ![BEC](../images/homebrew/BEC.png)

3. **Universal BEC**  
   ![UBEC](../images/homebrew/UBEC.jpeg)

4. **Battery Connector**  
   ![Bat Con](../images/homebrew/Bat_Con.jpeg)

## Solder Pads

The picture below shows the pads on the board where these components will be soldered.  
![PDB](../images/homebrew/PDB_diag_nonESC.jpeg)
...
![tape](../images/homebrew/tape2compo.jpeg)
