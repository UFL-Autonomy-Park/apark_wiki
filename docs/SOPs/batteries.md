...
When handling novel, damaged, or malfunctioning batteries:
- **Eye Protection:** Safety glasses.
- **Hand Protection:** Flame-retardant (FR) glove liners with a chemical-resistant outer glove (e.g., Nitrile) to protect against electrolyte leakage and flash fire.

### 2.2 Lithium Battery "Crash-Bins"
The lab maintains metallic containment bins for damaged/defective units.
- **Contents:** Non-combustible metallic container, inert bead lining (e.g., CellBlock or sand), and a Ziploc bag of additional beads.
- **Deployment:** Place the battery inside, cover with additional beads if the battery is hot, and place the lid loosely over the top.
- **Pressure Relief:** **Do not** re-attach latching rings or press-fit lids; pressure must be allowed to vent safely.
...
- **Pickup:** Schedule a hazardous waste pickup via the [UF EHS Portal](https://www.ehs.ufl.edu/forms/hazardous-waste-forms/).
- **Supplies:** Email **hwm@ehs.ufl.edu** if the lab is out of designated waste buckets.